...
public class CuRongGame {
	static JPanel panelNorth; //컨트롤+이름
	static JPanel panelCenter;
	static JLabel labelMessage;
	static JButton[] buttons = new JButton[16]; 
	static String[] images = { 
			"cat01.jpg","cat02.jpg","cat03.jpg","cat04.jpg",
			"cat05.jpg","cat06.jpg","cat07.jpg","cat08.jpg",
			"cat01.jpg","cat02.jpg","cat03.jpg","cat04.jpg",
			"cat05.jpg","cat06.jpg","cat07.jpg","cat08.jpg"
			};
		...
		implements ActionListener
	{
		...
		public MyFrame(String title) {
			...
			setLocationRelativeTo(null); //JFrame을 가운데로 배치하기
			...
			labelMessage.setForeground(Color.WHITE); //글씨 색
